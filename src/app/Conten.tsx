    ...
    <div className='container mx-auto px-4 py-8'>
      ...
      <div className='flex flex-col md:flex-row items-center justify-between mb-16'>
        ...
        <div className='w-full md:w-1/2 md:pl-8'>
          ...
          <p className='mb-4'>
            We let teams give you all the flexibility and tools to decide where
            and when to work that is best for you.
          </p>
      ...
      <div className='flex flex-col md:flex-row items-center justify-between'>
        ...
        <div className='w-full md:w-1/2 md:pr-8 md:order-1'>
          ...
          <p className='mb-4'>
            With your team working in harmony, you can move faster by tackling
            tasks together.
          </p>
          <a href='#' className='text-blue-500 hover:underline'>
            Learn more →
